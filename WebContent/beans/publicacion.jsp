...
<%
	...
	if ((contentType.indexOf("multipart/form-data") >= 0)) {
		...
		try {
			...
			while (i.hasNext()) {
				...
				if(fi.getFieldName().equals("contenido")) contenido = fi.getString();
				if (!fi.isFormField()) {
	...
	//Arrays.stream(valid_extensions).anyMatch(extension::equals);
	if(validExtension) {
	...
	} else session.setAttribute("error", i18n.getString("index.error.img.format")+" ("+extension+"). "+i18n.getString("index.error.img.format")+" "+Arrays.toString(valid_extensions));
